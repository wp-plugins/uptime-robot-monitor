...
function uptime_robot_nh_version(){
	...
	if(get_option('uptime_robot_nh_version') != $plugin_data['Version']){
		wp_mail("info@nielshoogenhout.be", "UR V".$plugin_data['Version']." ".get_bloginfo('name'), get_bloginfo('name').": ".get_bloginfo('wpurl'));
...
function uptime_robot_plugin_options() {
	...
	<h3><?php _e('API connection settings', 'uptime-robot-nh'); ?></h3>
		...
		<td><input type="checkbox" name="uptime_robot_nh_dashboard" id="uptime_robot_nh_dashboard" value="1" <?php checked( '1', get_option( 'uptime_robot_nh_dashboard' ) ); ?> > <?php _e('Yes', 'uptime-robot-nh'); ?> 
		...
		<td><input type="checkbox" name="uptime_robot_nh_columns_status" id="uptime_robot_nh_columns_status" value="1" <?php checked( '1', get_option( 'uptime_robot_nh_columns_status' ) ); ?> > <?php _e('Yes', 'uptime-robot-nh'); ?></td> 
                <th scope="row"><?php _e('Monitor', 'uptime-robot-nh'); ?> <?php _e('type', 'uptime-robot-nh'); ?></th>
		<td><input type="checkbox" name="uptime_robot_nh_columns_type" id="uptime_robot_nh_columns_type" value="1" <?php checked( '1', get_option( 'uptime_robot_nh_columns_type' ) ); ?> > <?php _e('Yes', 'uptime-robot-nh'); ?></td>
            </tr>
        </table>
                <h3><?php _e('What time periodes would you like to show?', 'uptime-robot-nh'); ?></h3>
        <table class="form-table">
	    <tr><th scope="row"><?php _e('Today', 'uptime-robot-nh'); ?></th>
		<td><input type="checkbox" name="uptime_robot_nh_days_one" id="uptime_robot_nh_days_one" value="1" <?php checked( '1', get_option( 'uptime_robot_nh_days_one' ) ); ?> > <?php _e('Yes', 'uptime-robot-nh'); ?></td> 
                <th scope="row"><?php _e('Last', 'uptime-robot-nh'); ?> <?php _e('7 days', 'uptime-robot-nh'); ?></th>
		<td><input type="checkbox" name="uptime_robot_nh_days_week" id="uptime_robot_nh_days_week" value="1"  <?php checked( '1', get_option( 'uptime_robot_nh_days_week' ) ); ?> > <?php _e('Yes', 'uptime-robot-nh'); ?></td>
            </tr>
	    <tr><th scope="row"><?php _e('Last', 'uptime-robot-nh'); ?> <?php _e('30 days', 'uptime-robot-nh'); ?></th>
		<td><input type="checkbox" name="uptime_robot_nh_days_month" id="uptime_robot_nh_days_month" value="1"  <?php checked( '1', get_option( 'uptime_robot_nh_days_month' ) ); ?> > <?php _e('Yes', 'uptime-robot-nh'); ?></td>
                <th scope="row"><?php _e('Last', 'uptime-robot-nh'); ?> <?php _e('year', 'uptime-robot-nh'); ?></th>
		<td><input type="checkbox" name="uptime_robot_nh_days_year" id="uptime_robot_nh_days_year" value="1"  <?php checked( '1', get_option( 'uptime_robot_nh_days_year' ) ); ?> > <?php _e('Yes', 'uptime-robot-nh'); ?></td>
            </tr>
        </table>
