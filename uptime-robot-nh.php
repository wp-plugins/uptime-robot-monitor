...
if(get_option('uptime_robot_nh_monitors','775657602') == ""){
	...
	$apiMonitors = get_option('uptime_robot_nh_monitors','775657602');
}
$url = "http://api.uptimerobot.com/getMonitors?apiKey=". $apiKey . "&customUptimeRatio=".substr($GetUptimes, 0, -1)."&format=xml&monitors=".$apiMonitors;
