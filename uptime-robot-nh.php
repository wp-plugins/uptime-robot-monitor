...
echo "</tr>";
$url = "http://api.uptimerobot.com/getMonitors?apiKey=". get_option('uptime_robot_nh_api','m775657602-b342a2e5f04a0e7707981fe8') . "".substr($GetUptimes, 0, -1)."&format=xml&monitors=".get_option('uptime_robot_nh_monitors','775657602');
...
$url = "http://api.uptimerobot.com/getMonitors?apiKey=". get_option('uptime_robot_nh_api','m775657602-b342a2e5f04a0e7707981fe8') . "&logs=1&format=xml&monitors=".get_option('uptime_robot_nh_monitors','775657602');
$xml = file_get_contents($url);
$xml = new SimpleXMLElement ($xml);
