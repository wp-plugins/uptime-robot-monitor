...
function uptime_robot_nh_settings_link($links) { 
  $settings_link = '<a href="options-general.php?page=uptime-robot-nh">Settings</a>'; 
  array_push($links, $settings_link); 
  return $links; 
}
 
$plugin = plugin_basename(__FILE__); 
add_filter("plugin_action_links_$plugin", 'uptime_robot_nh_settings_link' );
