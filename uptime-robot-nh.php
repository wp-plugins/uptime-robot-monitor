...
<img alt="" border="0" src="https://www.paypalobjects.com/nl_NL/i/scr/pixel.gif" width="1" height="1">
	...
	<h3><?php _e('API connection settings', 'uptime-robot-nh'); ?></h3>
		...
		<td><input type="checkbox" name="uptime_robot_nh_thanks_2" id="uptime_robot_nh_thanks_2" value="0" <?php checked( '0', get_option( 'uptime_robot_nh_thanks_2' ) ); ?> > <span class="description"> <?php _e('Plugin by <a href="https://wordpress.org/plugins/uptime-robot-monitor/" target="_blank">Niels Hoogenhout.nl</a>', 'uptime-robot-nh'); ?></span> </td>
            </tr>
        </table>
        <table class="form-table">
